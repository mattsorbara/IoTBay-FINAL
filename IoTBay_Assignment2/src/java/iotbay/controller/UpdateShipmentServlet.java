...
import shipment.model.dao.DBManager;

/**
 *
 * @author tanya
 */
@WebServlet(name = "UpdateShipmentServlet", urlPatterns = {"/UpdateShipmentServlet"})
public class UpdateShipmentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            manager.updateShipment(method, unitno, streetno, streetname, suburb, postcode, email);
